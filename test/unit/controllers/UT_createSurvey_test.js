...
describe('create category positive suit', async function() {
  it('should return valid values', async function() {
    ...
    try {
      ...
      let result = await dbLayer.createDoc({ data: reqObj }, '7i68gduygwduvwd', 'category');
      assert.equal(result.categoryId, '123');
    } catch (err) {
